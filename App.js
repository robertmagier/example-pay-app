...
import * as zksync from "@teamnumio/zksync";
...
export default class App extends Component<{}> {
  ...
  componentDidMount() {
    ...
    let zkSyncApi = new ZKAPI('rinkebyWss')
    this.setState({zkSyncApi})
  ...
  createWallet = async () => {
    let zkWallet = await this.state.zkSyncApi.createFromPrivateKey('0x'+hexPrivateKey)
    console.log(zkWallet.address)
  };
